...
{
  "id" : "InitiatePDXInvitation",
  "type" : "BusinessAction",
  "setupGroups" : [ "PMDM.BusinessRuleActions" ],
  "name" : "Initiate PDX Invitation",
  "description" : null,
  "scope" : "Global",
...
*/
exports.operation0 = function (node,logger,manager,dataIssuesReport,gateway,pdxChannelAccountUsers,mailHome,configurationEntity,emailReceiverAttribute,emailReceiverNameAttribute,emailFromAddressAttribute,emailSubjectAttribute,emailHeadingAttribute,emailBodyAttribute,emailFooterAttribute,pdxInvitationsAttribute,pdxClientIDAttribute,web,passwordGeneratorBusinessFunction,returnMessage,logLib) {
var forceLog = false;
...
if (response) {
	...
	web.showAlert("ACKNOWLEDGMENT", msg5, msg6);
}
}